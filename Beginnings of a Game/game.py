...
def print_menu(exits):
    ...
    for direction, i in exits.items():
...
def menu(exits):
    ...
    while True:
        ...
        direction_chosen = input("Which direction do you want to go in? ")
        direction_chosen = normalise_input(direction_chosen)

        if is_valid_exit(exits, direction_chosen):
